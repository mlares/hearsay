...
while (t_now<t_max):
    ...
    #t_now, ID, ID_alien, case = next_event
    ...
    if case==1:
        ...
        #print('       t_now : %f' % t_now)
        #print('       t_hola: %f' % t_hola)
        #print('       t_chau: %f' % t_chau)
        ...
        #print('asignando el proximo ID a %d+1' % ID)
    ...
    if case==2:
        ...
        #print('tatando de sacar de CHATs, en el indice: %d' % localID )
